...
1. Adding an agent record with `harness: <name>` in `SoftwareHouse/paperclip/organization.import.json`
2. Moving the harness yaml back to `SoftwareHouse/harnesses/`
