...
# via Hermes's env inheritance). Optionally writes per-agent ~/.hermes-<slug>/.env
# for isolation.
#
# Security:
...
echo "================================================================="
echo " Software House V8.5 — Secure API key setup"
echo "================================================================="
echo
if [ "$MODE_PER_AGENT" = "1" ]; then
    echo "Mode: per-agent (writes to each ~/.hermes-<slug>/.env)"
else
...
write_env_file() {
    ...
    {
        echo "# Software House V8.5 — generated by setup_api_keys.sh"
        ...
        if [ -f "$target" ]; then
            ...
            while IFS= read -r line; do
                case "$line" in
                    "# Software House V8.5 — generated by setup_api_keys.sh") in_old_header=1; continue ;;
