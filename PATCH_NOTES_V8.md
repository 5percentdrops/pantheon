# V8 Patch Notes — Paperclip + Hermes Corrected Pantheon

## Summary

This patch upgrades the existing Pantheon V7 repo into a V8 Paperclip/Hermes control-plane package.
...
- `Pantheon/policies/paperclip_control_plane_policy.md`
- `Pantheon/policies/hermes_harness_runtime_policy.md`
...
- `Pantheon/paperclip/organization.import.json` now uses `paperclip-org-import.v8`.
...
Note: the environment emitted unrelated spreadsheet runtime warmup warnings from the container Python startup hook. The Pantheon validators passed and the shell commands exited successfully.
